...
const swatches = [
  ...
  { name: 'base-light', hex: '#FDFCF8', usage: 'Fond principal du site' },
  ...
  return (
    <main id="contenu">
      <Section>
        ...
        <h3 className="mt-14 text-h3">Palette</h3>
          ...
          {swatches.map((s) => (
            <Card key={s.name}>
              ...
              <CardBody className="p-5">
                ...
                <p className="text-small uppercase text-text-muted">{s.hex}</p>
                <p className="mt-2 text-small text-text-muted">{s.usage}</p>
              </CardBody>
            </Card>
          ))}
        </div>

        <h3 className="mt-14 text-h3">Typographie</h3>
        <div className="mt-6 space-y-4 border-l-2 border-border pl-6">
          <p className="text-h1">Fraunces · Titre H1</p>
          <p className="text-h2">Fraunces · Titre H2</p>
          <p className="text-h3">Fraunces · Titre H3</p>
          <p>Inter · Corps de texte, 17 px, interlignage 1.65 pour une lecture reposante.</p>
          <p className="text-small text-text-muted">Inter · Mention secondaire, 14 px.</p>
        </div>

        <h3 className="mt-14 text-h3">Boutons</h3>
        ...
        <h3 className="mt-14 text-h3">Champs de saisie</h3>
        ...
        <h3 className="mt-14 text-h3">Cartes</h3>
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <Card className="bg-night text-base-light">
            <CardBody>
              <CardTitle>Registre solennel</CardTitle>
              <CardText className="mt-2 text-base-light/75">Ivoire sur brun nuit, réservé au packaging premium.</CardText>
            </CardBody>
          </Card>
        </div>
      </Section>
